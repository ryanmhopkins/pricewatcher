...
create table if not exists monitors(id uuid primary key default gen_random_uuid(),name text not null,url text not null,created_at timestamptz not null default now(),last_checked_at timestamptz,last_status text not null default 'new');
